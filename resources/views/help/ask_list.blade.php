...
<div class="Help">
    <div class="Help_nav">
        ...
        <div class="Help_seach">
        	<div class="left_ds">您的位置：<span>投诉咨询</span>@if(isset($_GET['type']) && in_array($_GET['type'],[1,2,3]))>><span>@if($_GET['type']==1)咨询@elseif($_GET['type']==2)建议@else投诉@endif</span>@endif>><span>{{$cate}}列表</span></div>
                    ...
                    <ul class="helpList">
                        ...
                        <li>
                            <p class="que_title left">
                                <a href="{{url('/help/ask/detail/'.$v['id'].'?type='.$_GET['type'])}}">{{$v['ask_title']}}</a>
                            </p>
