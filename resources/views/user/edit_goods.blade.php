...
<div class="all">
    <div class="place">
        <p>您现在的位置：{!! Breadcrumbs::render('my_sell_edit') !!}</p>
    </div>
    ...
    <form id="PostFrom" action="{{url('/user/EditGoods')}}" method="post" class="form" target="_blank">
        {{csrf_field()}}
        <div class="message">
            <div class="product">
                <h3>
                ...
                <div class="form">
                    <ul>
                        <li class="t">
                            ...
                            @if(strstr($type['type'],"币"))
                                <li>
                                    ...
                                    <div class="formright left">
                                        <input class="input2 req W100 money NeedNum" name="one_num" type="text" datatype="n" value="{{$goods['one_number']}}">
                            ...
                            @endif
                                <li>
                                    ...
                                    <div class="formright left">
                                        <input class="input2 req money W100 NeedPrice" name="goods_price" value="{{$goods['goods_price']}}" type="text" datatype="/^[1-9]{1}\d*(\.\d{1,2})?$/" errormsg="{{trans('com.error_goods_price')}}">  元
                                    </div>
                                    <div class="ts icon1 left"></div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="formright left">
                                        <input class="input2 req GameName" name="goods_name" type="text" style="width:200px;" datatype="*" value="{{$goods['goods_name']}}">
                                    </div>
                                    <div class="ts icon1 left"></div>
                                </li>
                        ...
                        <li>
                            ...
                            <div class="formright left">
                                <input class="input2 req int W100 fabujian" name="goods_stock" type="text" value="{{$goods['goods_stock']}}" datatype="n">
                            </div>
                        </li>
                        <li>
                            <input type="hidden" name="gid" value="{{$goods['id']}}">
                            <input type="hidden" name="vip_level" value="{{$vip_level['max_time']}}">
                            <label class="left"><span class="red">*</span> 商品描述:</label>
                            <div class="formright left">
                                <textarea style="width:76%;height:120px;font-size:12px;line-height:20px" name="goods_content" datatype="*">{{$goods['goods_content']}}</textarea>
                        ...
                        <li>
                            ...
                            <div class="img_left">
                            <span>
                               <input id="file_upload_more" name="file_upload_more" type="file" class="_file" multiple="true">
                                <div class="ts icon1 left" data-moren="" data-right="" data-error="">只允许上传以gif，jpg，png结尾的图片,可以一次上传多张</div>
                            </span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="formright left" id="img_more">
                                @foreach($goods_pic as $v)
                                    <div style="width: 100px;height:100px;float: left;margin-left: 10px;position: relative">
                                        <span onclick="del_pic_this(this)" style="position: absolute;right: 0;cursor: pointer;"><i class="fa-minus-square-o"></i></span>
                                        <input type="hidden" value="{{$v->picture}}" name="pictrue[]" />
                                        <input type="hidden" value="{{$v->id}}" name="pictrue_id[]" />
                                        <td><img src="{{$v->picture}}"  style="max-width: 100px;max-height: 100px;"> </td>
                                    </div>
                                @endforeach
                            </div>
                        </li>
                ...
                <div class="form">
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="formright left">
                                <input class="input2 left req" name="game_user" type="text" datatype="*" value="{{$goods_user_info['game_user']}}">
                            </div>
                        </li>
                        @if(strstr($type['type'],"帐号"))
                        ...
                        @endif
                        @if($goods['traded_type']=='0')
                        <li>
                            <label class="left"><span class="red">*</span>游戏帐号</label>
                            <div class="formright left">
                                 <input class="input2 left req" name="game_user_name" type="text" datatype="*" value="{{$goods_user_info->game_user_name}}">
                            </div>
                        </li>
                        <li>
                            <label class="left"><span class="red">*</span>帐号密码</label>
                            <div class="formright left">
                                <input class="input2 left req" name="game_user_pwd" type="password" datatype="*" value="{{$goods_user_info->game_user_pwd}}">
                            </div>
                        </li>
                        <li>
                            <label class="left"><span class="red">*</span>注册帐号身份证</label>
                            <div class="formright left">
                                <input class="input2 left req" name="datacard" type="text" ignore="ignore" datatype="idcard" value="{{$goods_user_info->datacard}}">
                        ...
                        <li>
                            ...
                            <div class="formright left" style="position:relative">
                                <input id="secretcard_img" name="secretcard_img" type="file" class="_file" multiple="false" >
                                <div class="ts icon1 left" data-moren="" data-right="" data-error="">
                                    如没有则不填写
                                </div>
                                <div class="ts icon1 left" data-moren="" data-right="" data-error="" id="secretcard_img_p" style="display:none">
                                    <img style="max-width: 100px;max-height:100px" src="{{$goods_user_info->secretcard_img}}">
                                    <input  name="secretcard_img" type="hidden"  id="secretcard_img_i" value="{{$goods_user_info->secretcard_img}}">
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="formright left">
                                <input class="input2 left req" name="mb_tel" type="text" ignore="ignore" datatype="*" value="{{$goods_user_info->mb_tel}}">
                                <div class="ts icon1 left" data-moren="" data-right="" data-error="">如没有则不填写</div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="formright left">
                                <input class="input2 left req" name="mb_question" type="text" ignore="ignore" datatype="*" value="{{$goods_user_info->question}}">
                                <div class="ts icon1 left" data-moren="" data-right="" data-error="">如没有则不填写</div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="formright left">
                                <input class="input2 left req" name="mb_answer" type="text" ignore="ignore" datatype="*" value="{{$goods_user_info->answer}}">
                                <div class="ts icon1 left" data-moren="" data-right="" data-error="">如没有则不填写</div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="formright left">
                                <input class="input2 left req" name="two_level_pass" type="password" ignore="ignore" datatype="*" value="{{$goods_user_info->two_level_pass}}">
                                <div class="ts icon1 left" data-moren="" data-right="" data-error="">如没有则不填写</div>
                            </div>
                        </li>
                        @endif
                ...
                <div class="form">
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="formright left">
                                <input class="input2 left hide_phone" name="game_user_tel"  type="text" value="{{$goods_user_info['game_user_tel']}}"  datatype="/^1[34578]\d{9}$/" errormsg="{{trans('com.error_phone')}}">
                            </div>
                        </li>
                        <li>
                            <label class="left"><span class="red">*</span>您的QQ号码</label>
                            <div class="formright left">
                                <input class="input2 left hide_qq" name="game_user_qq" type="text" value="{{$goods_user_info['game_user_qq']}}"  datatype="n4-13" errormsg="{{trans('com.error_qq')}}" >
                            </div>
                ...
                <div class="form">
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="formright left">
                                <select class="input2"  name="security" datatype="*">
                                    ...
                                    <option value="{{$v}}" @if($v==$goods['security'])selected="selected"@endif>{{$v}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="ts icon1 left" data-moren="" data-right="" data-error="">请选择对买家的安保措施</div>
                        </li>
                        @if($goods['traded_type']=='1')
                        <li>
                            <label class="left"><span class="red">*</span>交易暗号</label>
                            <div class="formright left">
                                <input class="input2 left hide_phone" name="code"  type="text" value="{{$goods->code}}" ignore="ignore"  datatype="*" errormsg="{{trans('com.error_phone')}}">
                            </div>
                        ...
                        <li>
                            ...
                            <div class="formright left">
                                <input class="input2 left hide_phone" name="pwd"  type="text" value="{{$goods->pwd}}" ignore="ignore"  datatype="*" errormsg="{{trans('com.error_phone')}}">
                ...
                <div class="form">
                    ...
                    <ul>
                        <li class="t">
                            ...
                            <div class="formright left">
                                <select name="sale_end_time" id="OverDay" datatype="*">
                                    ...
                                    <option value="{{$i}}" @if($i==$days)selected="selected"@endif>{{$i}}天</option>
                                    @endfor
                                </select>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="formright left">
                                <select class="input2"  name="best_time" datatype="*">
                                    @foreach(trans('time') as $v)
                                    <option value="{{$v}}" @if($v==$goods['best_time'])selected="selected"@endif>{{$v}}</option>
                                    @endforeach
                                </select>
                        ...
                        <li>
                            ...
                            <div class="formright left">
                                <input type="radio" name="to_money" value="0" @if($goods['to_money']=='0')checked="checked"@endif onchange="showAccount()">平台账户
                                <input type="radio" name="to_money" value="1" @if($goods['to_money']=='1')checked="checked"@endif onchange="showAccount()">我的银行卡
                            </div>
                        </li>
                        <li id="bank" style=" display:@if($goods['to_money']=='1')block@else none @endif">
        ...
        <div class="button clear_both">
            <a href="javascript:void(0);" id="BtnSubmit"><strong>确认，提交修改</strong></a>
        </div>
    </form>
</div>
        ...
        $('#file_upload_more').uploadify({
            ...
            'onUploadSuccess' : function(file, data, response) {
                ...
                $html += '<div style="width: 100px;height:100px;float: left;margin-left: 10px;position: relative">',
                        ...
                        $html +='<input type="hidden" value="'+data+'" name="pictrue_id[]" />',
                        $html += '</div>'
