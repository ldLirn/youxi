...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; <a href="{{url('admin/user_rank')}}">会员等级管理</a> &raquo; 添加等级
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    <form action="{{url('admin/user_rank')}}" method="post">
        <table class="add_tab">
            <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="min_points" value="{{old('min_points')}}">
                </td>
            </tr>
            <tr>
                <th><i class="require">*</i>积分上限：</th>
                <td>
                    <input type="text" name="max_points" value="{{old('max_points')}}">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="max_issue" value="{{old('max_issue')}}">
                </td>
            </tr>
            <tr>
                <th><i class="require">*</i>最长有效期天数：</th>
                <td>
                    <input type="text" name="max_time" value="{{old('max_time')}}">
                </td>
            </tr>
            <tr>
                <th><i class="require">*</i>最大求降价数量：</th>
                <td>
                    <input type="text" name="max_changePrice" value="{{old('max_changePrice')}}">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" name="rank_img" value="">
                    <img src="" id="rank_img" style="max-width: 300px;max-height: 100px;">
                </td>
            </tr>
