...
@section('content')
    <style xmlns:javascript="http://www.w3.org/1999/xhtml" xmlns:javascript="http://www.w3.org/1999/xhtml">
    ...
    <form action="{{url('admin/trash/all_do')}}" method="post" id="all_do">
        <div class="result_wrap">
            <ul class="tab">
                @if(isset($_GET['type']))
                    <li @if(isset($_GET['type']) && $_GET['type']=='0')class="active"  @endif><a href="{{url('admin/trash?type=0')}}">寄售交易</a></li>
                    <li @if(isset($_GET['type']) && $_GET['type']=='1')class="active"  @endif><a href="{{url('admin/trash?type=1')}}">担保交易</a></li>
                    <li @if(isset($_GET['type']) && $_GET['type']=='2')class="active" @endif><a href="{{url('admin/trash?type=2')}}">求购交易</a></li>
                @else
                    <li class="active"><a href="{{url('admin/trash?type=0')}}">寄售交易</a></li>
                    <li><a href="{{url('admin/trash?type=1')}}">担保交易</a></li>
                    <li><a href="{{url('admin/trash?type=2')}}">求购交易</a></li>
                @endif
