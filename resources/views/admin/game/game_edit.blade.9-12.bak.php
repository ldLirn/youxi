        ...
        <div class="tab_content">
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <dl class="attr_type">
                            <dt><i class="require">*</i>种类名：<input type="text" name="type_name[]" value="{{$v['type']}}"> <span onclick="add_type(this)"><i class="fa fa-plus-circle"></i></span></dt>
    ...
    <script>
        ...
        function add_type(obj){
            var attr = '<tr>\
                    ...
                    <td>\
                        <dl class="attr_type">\
                            <dt>种类名：<input type="text" name="type_name[]"> <span onclick="add_type(this)"><i class="fa fa-plus-circle"></i></span></dt>\
                        </dl>\
                    </td>\
                </tr>';
            $(obj).parents('tr').eq(0).after(attr);
