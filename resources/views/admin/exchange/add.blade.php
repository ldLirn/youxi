...
<link rel="stylesheet" type="text/css" href="{{asset('/public/org/uploadify/uploadify.css')}}">
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; <a href="{{url('admin/exchange')}}">积分商城</a> &raquo; 添加商品
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('admin/exchange')}}" method="post">
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th></th>
                        <input type="hidden" value="" name="pic" id="thumb"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text"  name="max_exchange">
                        </td>
                    </tr>
                    <tr>
