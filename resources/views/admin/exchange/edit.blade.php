...
<link rel="stylesheet" type="text/css" href="{{asset('/public/org/uploadify/uploadify.css')}}">
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; <a href="{{url('admin/exchange')}}">积分商城</a> &raquo; 修改商品
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <form action="{{url('admin/exchange/'.$data->id)}}" method="post">
            <table class="add_tab">
                <tbody>
                    <tr>
                        <th><i class="require">*</i>{{trans('shop.goods_name')}}</th>
                        <td>
                            <input type="text" class="lg" name="goods_name" value="{{$data['goods_name']}}">
                    ...
                    <tr>
                        <th></th>
                        <input type="hidden" value="{{$data['pic']}}" name="pic" id="thumb"/>
                        <td><img src="{{$data['pic']}}" id="art_img" style="max-width: 300px;max-height: 100px;"> </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>所需积分：</th>
                        <td>
                            <input type="text"  name="integral" value="{{$data['integral']}}">
                        </td>

                    </tr>
                    <tr>
                        <th><i class="require">*</i>每人最大兑换数量：</th>
                        <td>
                            <input type="text"  name="max_exchange" value="{{$data['max_exchange']}}">
                        </td>
                    </tr>
                    <tr>
