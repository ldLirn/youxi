...
<link rel="stylesheet" type="text/css" href="{{asset('/public/org/uploadify/uploadify.css')}}">
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; <a href="{{url('admin/application')}}">异常申请管理</a> &raquo; 添加链接
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <label for=""><input type="radio" name="link_type" value="0" checked="checked" onclick="showTr()">文字链接</label>
                            <label for=""><input type="radio" name="link_type" value="1" onclick="showTr()">图片链接</label>
                    ...
                    <tr>
                        <th></th>
                        <input type="hidden" value="" name="link_logo" id="thumb"/>
