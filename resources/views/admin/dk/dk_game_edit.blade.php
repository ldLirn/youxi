...
<link rel="stylesheet" type="text/css" href="{{asset('/public/org/uploadify/uploadify.css')}}">
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; <a href="{{url('admin/dk_game_list')}}">点卡游戏管理</a> &raquo; 修改游戏
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <form action="{{url('admin/dk_game_edit/'.$data['cardid'])}}" method="post">
            <table class="add_tab">
                <tbody>
                    <tr>
                        <th><i class="require">*</i>点卡游戏名称：</th>
                        <td>
                    ...
                    <tr>
                        <th></th>
                        <input type="hidden" value="{{$data['cardimg']}}" name="thumb" id="thumb"/>
                        <td><img src="{{$data['cardimg']}}" id="art_img" style="max-width: 300px;max-height: 100px;"> </td>
                    </tr>
