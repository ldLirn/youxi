...
<link rel="stylesheet" type="text/css" href="{{asset('/public/org/uploadify/uploadify.css')}}">
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; <a href="{{url('admin/link')}}">轮播图管理</a> &raquo; 修改轮播图
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="banner_name" value="{{$data->banner_name}}">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="banner_url" value="{{$data->banner_url}}">
                    ...
                    <tr>
                        <th></th>
                        <input type="hidden" value="{{$data->banner_img}}" name="banner_img" id="thumb"/>
                        <td><img src="{{$data->banner_img}}" id="art_img" style="max-width: 300px;max-height: 100px;"> </td>
                    </tr>

                    <tr>
                        <th>排序：</th>
                        <td>
                            <input type="text" class="sm" name="banner_order" value="{{$data->banner_order}}">
                        </td>
                    </tr>
                    {{method_field('PUT')}}
                    {!! csrf_field() !!}
