...
return [
    ...
    'validation' => [
        'mobile' => [
            ...
            'staticRules' => [
                ...
                'check_mobile_unique' => 'required|zh_mobile|unique:users,telphone',
                'check_mobile_exists' => 'required|zh_mobile|exists:users,telphone',
            ],
        ],
    ],
    ...
    */
    'verifySmsContent' => function ($code, $minutes, $input) {
        return '亲爱的用户，您的验证码是' . $code . '。有效期为' . $minutes . '分钟，请尽快验证。【搜付在线】';
    },
...
//        },
    ...
    */
    'storage' => [
        'driver' => 'Toplan\Sms\SessionStorage',
        'prefix' => 'laravel_sms',
    ],
